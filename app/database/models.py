...
class PizzaType(Base):
    ...
    toppings: Mapped[List['PizzaTypeToppingQuantity']] = relationship(CASCADE_ALL_DELETE_ORPHAN,
...
class User(Base):
    ...
    customer_orders: Mapped[List['Order']] = relationship(CASCADE_ALL_DELETE_ORPHAN, back_populates='user')
...
class Order(Base):
    ...
    order_datetime: Mapped[datetime.datetime] = mapped_column(DateTime(timezone=True), default=func.now(),
                                                              nullable=True)
    beverages: Mapped[List['OrderBeverageQuantity']] = relationship(CASCADE_ALL_DELETE_ORPHAN,
    ...
    pizzas: Mapped[List['Pizza']] = relationship(CASCADE_ALL_DELETE_ORPHAN)
